...
const ReinigingsdienstenDenBosch = () => {
    const location = 'Den Bosch';
    const locationSlug = 'den-bosch';
    const locationFull = "'s-Hertogenbosch";
    
    const faqSchema = generateFAQSchema(SERVICE_FAQ_DATA);
    const serviceSchema = generateServiceSchema({
        name: `Reinigingsdiensten ${locationFull}`,
        description: `Professionele reinigingsdiensten in ${location} (${locationFull}). Oprit reiniging, gevelreiniging en onkruidbeheersing door Bereschoon.`,
    ...
    return (
        <PageTransition>
            <SEO
                ...
                description={`Professionele reinigingsdiensten in ${location} (${locationFull}). Oprit reiniging, gevelreiniging en onkruidbeheersing door Bereschoon. Vrijblijvende offerte aanvragen.`}
                keywords={`reinigingsdiensten ${location}, reinigingsdiensten ${locationFull}, oprit reiniging ${location}, gevelreiniging ${location}, onkruidbeheersing ${location}, terras reinigen ${location}, buitenreiniging ${location}`}
            ...
            <ServiceHero
                ...
                description={`Bereschoon is uw specialist voor professionele reinigingsdiensten in ${location} (${locationFull}) en omgeving. Wij reinigen uw oprit, terras, gevel en terrein met geavanceerde technieken. Vraag vandaag nog een vrijblijvende offerte aan.`}
                images={[
                ...
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
                            Bereschoon biedt complete reinigingsoplossingen voor uw buitenruimte in {location} en omgeving. Van oprit tot gevel, wij zorgen voor een verzorgde uitstraling.
                        </p>
                    </div>
...
export default ReinigingsdienstenDenBosch;
